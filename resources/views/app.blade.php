        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
                <div class="sidebar-brand-icon ">
                 ...
                 {{-- <div class="sidebar-brand-text mx-3 ">Veterinary System</div> --}}
            </a>
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="/whyUs">
                    <i class="fa-solid fa-house"></i>
                    <span class="fw-bold">Why Us</span>
                </a>
            ...
            <li class="nav-item ">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded ">
                        ...
                        {{-- <a class="collapse-item" href="{{ url('/users/manage') }}">Access</a> --}}
                        <a class="collapse-item" href="{{ url('/users/manage') }}">Manage</a>
                    </div>
                </div>
            </li>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="/logoutSystem">Logout</a>
                    </div>
                </div>
            </div>
        </div>
